...
const texts: Record<string, LocalizedText> = {
  ...
  description: { en: 'Make IQLAA work the way you want', ar: 'اجعل إقلاع يعمل بالطريقة التي تريدها', fr: 'Faites fonctionner IQLAA comme vous le souhaitez', dz: 'خلي إقلاع يخدم كيما تحب' },
  ...
  about: { en: 'About IQLAA', ar: 'حول إقلاع', fr: 'À propos de IQLAA', dz: 'على إقلاع' },
  ...
  aboutTitle: { en: 'About IQLAA', ar: 'حول إقلاع', fr: 'À propos de IQLAA', dz: 'على إقلاع' },
  aboutMeaning: { en: 'IQLAA means "Takeoff" in Arabic', ar: 'إقلاع تعني الانطلاق', fr: 'IQLAA signifie "Décollage" en arabe', dz: 'إقلاع معناها الانطلاق' },
